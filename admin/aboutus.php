...
$query=mysqli_query($con,"update safaris set aboutSafari= '$pagedes' where SafariName = '$Safari'");
    if ($query) {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="" name="">
                                            <div class="form-group">
                                                ...
                                                <textarea name="pagedes" required='true' cols="100" rows="10" %
                                                    width="50%">
                                                    <?php  echo $row['aboutSafari'];?></textarea>
                                            </div>
